...
StringPolicy::StringPolicy(const std::string name, const std::string &vendorName, const std::string &productName, const std::string &registryPath)
    : RegistryPolicy(name, vendorName, productName, {REG_SZ, REG_MULTI_SZ}, registryPath) {}
