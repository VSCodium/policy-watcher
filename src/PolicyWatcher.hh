...
public:
  ...
  PolicyWatcher(std::string vendorName, std::string productName, const Function &okCallback, std::string registryPath)
      : PolicyWatcher(vendorName, productName, okCallback)
  {
